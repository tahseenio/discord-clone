...
export default function Device( {name, img} ) {
  ...
  return (
    <div className='device--wrapper'>
      ...
      {(name !== 'Linux') 
        ? <a href="" className="device__btn">Download</a>
        : <>
            <div className="linux-dropdown">
              ...
              <div className='linux-dropdown__list'>
                <a className='linux__link' href="" onClick={() => ToggleLinuxDropdown()}>deb</a>
                <a className='linux__link' href="" onClick={() => ToggleLinuxDropdown()}>tar.gz</a>
              </div>
            </div>
          </> 
      }
